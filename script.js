...
// OČIŠĆENA VERZIJA - BEZ GLASA, BEZ CHOICE EKRANA
// Tok: Login → Jezik → Kategorije → Podkategorije → Delovi → Forma
// ============================================
...
function getCurrentLang() {
    return window.currentLang || localStorage.getItem('appLanguage') || 'sr';
}

// ===== IZBOR JEZIKA - ODMAH NA KATEGORIJE =====
...
window.sacuvajAzuriranje = sacuvajAzuriranje;
window.toggleAllCheckboxes = toggleAllCheckboxes;
window.toggleAllShopping = toggleAllShopping;
...
window.updateHeaderLanguage = updateHeaderLanguage;

console.log('✅ Sve funkcije izvezene!');
